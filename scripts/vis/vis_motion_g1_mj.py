...
if __name__ == "__main__":
    ...
    motion_file = "sample_data/dance_sample_g1.pkl"
    # motion_file = "data/amass/amass_train_take6.pkl"
    # motion_file = "output/HumanoidIm/unitree_g1_pnn/failed_0000006000.pkl"
    ...
    test_good = f"/tmp/smpl/g1.xml"
    smpl_robot.write_xml(test_good)
    smpl_robot.write_xml("g1.xml")
